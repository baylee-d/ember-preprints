    ...
    components: {
        ...
        'preprint-status-banner': {
            message: {
                ...
                pending_withdrawal: 'This {{documentType.singular}} has been requested by the administrators to be withdrawn. It will still be publicly searchable until the request has been approved.',
