...
export default {
    ...
    withdraw: {
        ...
        pre_moderation_notice: 'This service uses pre-moderation. Because of that, your {{documentType.singular}} can be withdrawn at any time even it\'s still pending approval. If moderation is still pending at the time of withdrawal, your {{documentType.singular}} will be withdrawn without needing moderator approval. It will not have a tombstone page and it will not be searchable.',
